...
if (!isset($_GET['case_no']) || empty($_GET['case_no'])) {
    $_SESSION['error'] = "No case specified.";
...
// Fetch case details for this client, including client and lawyer names
$caseQuery = "SELECT c.*, cl.name AS client_name, cl.email AS client_email, cl.phone AS client_phone, cl.address AS client_address, cl.country AS client_country, cl.state AS client_state, cl.city AS client_city, u.name AS lawyer_name
FROM cases c
LEFT JOIN clients cl ON c.client_id = cl.id
LEFT JOIN users u ON c.lawyer_id = u.id
WHERE c.case_no = ? AND c.client_id = ?";
$stmt = $conn->prepare($caseQuery);
$stmt->bind_param("si", $case_no, $client_id);
$stmt->execute();
$case = $stmt->get_result()->fetch_assoc();
$stmt->close();

if (!$case) {
    $_SESSION['error'] = "Case not found or you do not have access.";
    header('Location: dashboard.php');
    exit();
}
?>
...
<head>
  ...
  <title>Case Detail | Nabihah Ishak & CO.</title>
                ...
                <table class="table text-nowrap align-middle mb-0">
                  ...
                  <tbody class="table-group-divider">
                    ...
                    <tr>
                      ...
                      <td><?= htmlspecialchars($file['file_description'] ?? '') ?></td>
                      ...
                      <td class="text-center fw-medium">
                        ...
                        <a href="../includes/client/delete_case_file.php?id=<?= $file['id'] ?>&case_id=<?= $case['id'] ?>" 
  ...
  <div class="modal fade" id="addProgressModal" tabindex="-1" aria-labelledby="addProgressModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="../includes/client/add_case_progress.php" method="POST">
